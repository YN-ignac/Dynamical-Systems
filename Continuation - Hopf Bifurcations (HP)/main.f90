! To create .exe: gfortran -o kontinuaceHB.exe gauss.f90 main.f90
! To run .exe: .\kontinuaceHB.exe
! Plot: python -u "c:\Fortran projects\MANDM\Hopf-Bifurcation\plotHB.py"
program kontinuace
    implicit none
